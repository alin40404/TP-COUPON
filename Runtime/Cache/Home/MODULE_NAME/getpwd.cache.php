<? if (!class_exists('template')) die('Access Denied');$template->getInstance()->check('getpwd.html', 'ad91d6ee5cc76bc908e3533ced2242b5', 1359969520);?>
        ...
        <div id="main">
            <div class="main_l">
                <div id="main_l_l" class="clear">
                    ...
                    <ul class="clear">
                    <form action="<? echo reUrl('User/getpwd'); ?>" method="post" name="login_form" id="login_form">
...
var getpwd_url = "<? echo reUrl('User/getpwd'); ?>";
function editpwd()
{
	$.ajax({
		url: getpwd_url,
